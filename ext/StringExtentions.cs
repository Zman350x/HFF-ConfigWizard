...
namespace cwiz.ext {
    public static class StringExtensions {
        public static string ToLines(this string[] self) => string.Join(System.Environment.NewLine, self);
        ...
        public static string JoinWith(this string self, string other, string seperator) =>
